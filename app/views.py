...
def posts(id):
	...
	if not randFact:
		...
		email = mailto(randFact[0]['FactText'],randFact[0]['ID'])
...
def post_html(id):
	...
	email = mailto(randFact['FactText'],id)
